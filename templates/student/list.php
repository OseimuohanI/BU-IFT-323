...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="<?= BASE_URL ?>/?controller=student&action=edit&id=<?= $s['StudentID'] ?>">Edit</a> |
            <a href="<?= BASE_URL ?>/?controller=student&action=delete&id=<?= $s['StudentID'] ?>" onclick="return confirm('Delete?')">Delete</a>
        </td>
    </tr>
    <?php endforeach; ?>
</table>